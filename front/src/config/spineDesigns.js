...
const SPINE_DESIGNS = {
  ...
  NES: {
    ...
    textBottom: "#ffffff",
    accent: "#e60012",
    coverGrad: "linear-gradient(180deg, #3a3a3a 0%, #111111 100%)",
    width: "thick",
    height: "normal",
  },
  ...
  Game_Boy: {
    ...
    textBottom: "#ffffff",
    accent: "#30308f",
    coverGrad: "linear-gradient(180deg, #d8d8cf 0%, #858b79 100%)",
    width: "thin",
    height: "short",
  },
  ...
  Game_Boy_Color: {
    ...
    textBottom: "#ffffff",
    accent: "#ff5aa5",
    coverGrad: "linear-gradient(180deg, #6fd6ff 0%, #1f88c9 100%)",
    width: "thin",
    height: "short",
  },
  ...
  Game_Boy_Advance: {
    ...
    textBottom: "#ffffff",
    accent: "#8b6ff2",
    coverGrad: "linear-gradient(180deg, #a98eff 0%, #5a3f9e 100%)",
    width: "thin",
    height: "short",
  },
